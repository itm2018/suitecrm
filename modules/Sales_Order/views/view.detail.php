...
class Sales_OrderViewDetail extends ViewDetail {
     ...
     */
    function Sales_OrderViewDetail(){
	...
	function populateOrderTemplates(){
		...
		$sql = "SELECT id, name FROM aos_pdf_templates WHERE deleted = 0 AND type='Sales_Order' AND active = 1";
